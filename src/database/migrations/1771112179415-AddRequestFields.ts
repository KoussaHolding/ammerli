...
export class AddRequestFields1771112179415 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "requests" ADD "pickupLat" double precision`);
        await queryRunner.query(`ALTER TABLE "requests" ADD "pickupLng" double precision`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."requests_status_enum" AS ENUM('SEARCHING', 'DISPATCHED', 'ACCEPTED', 'ARRIVED', 'IN_PROGRESS', 'COMPLETED', 'EXPIRED', 'CANCELLED')`);
        ...
        await queryRunner.query(`ALTER TABLE "requests" ALTER COLUMN "status" SET DEFAULT 'SEARCHING'`);
        await queryRunner.query(`DROP TYPE "public"."requests_status_enum_old"`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."requests_status_enum_old" AS ENUM('SEARCHING', 'DISPATCHED', 'ACCEPTED', 'COMPLETED', 'EXPIRED', 'CANCELLED')`);
        await queryRunner.query(`ALTER TABLE "requests" ALTER COLUMN "status" DROP DEFAULT`);
