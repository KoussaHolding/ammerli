...
export class NotificationController {
  ...
  async registerToken(@CurrentUser() user: UserEntity, @Body() dto: RegisterTokenDto) {
    ...
    return await this.notificationService.saveToken(user.id, dto.token, dto.platform, userType);
  }
}
